...
def rectangles_from_circles(circles):
    ...
    for k in range(len(circles)):
        center = rg.Point(circles[k].center.x, circles[k].center.y)
        p1 = rg.Point(center.x - circles[k].radius, center.y - circles[k].radius)
        p2 = rg.Point(center.x + circles[k].radius, center.y + circles[k].radius)
